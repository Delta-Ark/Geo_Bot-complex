...
class TestWrite(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tokens = nltk.word_tokenize('Numerous passing references to the phrase have occurred in movies')
    ...
    def test_traverse_tree_grab_phrases(self):
        ...
        for k,v in phrases.items():
            print '{} : {}'.format(k,v)
        self.assertEqual(phrases['NP'], ['Numerous passing references', 'the phrase', 'movies'])
        self.assertEqual(phrases['VP'],['have occurred in movies', 'occurred in movies'])
