...
def convert_geocoordinates(latitude_degrees, longitude_degrees, radius_miles):
    ...
    long_km_per_degree = circ_of_earth_km_at_lat / 360
    print "long_km_per_degree = {} at {}".format(
        long_km_per_degree, latitude_degrees)
    long_delta = radius_km / long_km_per_degree
    # print "longitudinal delta = {}".format(long_delta)
    lon1 = longitude_degrees - long_delta
    lon2 = longitude_degrees + long_delta
    # print lon1
    # print lon2
